...
abstract class AbstractOverviewController extends AbstractViewController
{
    ...
    public static function getCleanViewData(Request $request): array
    {
        $instance = new static();
        $instance->loadData($request);

        return $instance->appendViewData($request);
    }

    /**
     * @inheritdoc
     */
    public function appendViewData(Request $request): array
    {
        $data = [
        ...
        if ($this instanceof EmptyTableViewInterface) {
            $data['emptyViewObject'] = $this->getEmptyViewValueObject();
